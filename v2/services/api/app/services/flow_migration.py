...
from app.core.error_codes import UNSUPPORTED_SCHEMA_VERSION
from app.schemas.contracts import FLOW_SCHEMA_VERSION, FlowModel
...
def migrate_flow_model(flow: FlowModel) -> FlowModel:
    ...
    raise FlowMigrationError(
        ...
        message=(
            ...
            f"Current API supports {FLOW_SCHEMA_VERSION}."
        ),
